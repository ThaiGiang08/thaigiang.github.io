...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://github.com/ThaiGiang08', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Facebook');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/thaigiang2', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Tiktok');
    telegramDiv.addEventListener('click', function () {
        window.open('https://tiktok.com/@_thaigiang0', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Youtube');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.youtube.com/@_thaigiang', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Zalo');
    telegramDiv.addEventListener('click', function () {
        window.open('https://zalo.me/0383684708', '_blank');
    });
});
...
welcomeText.textContent = "=>> 𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙃𝙪𝙣𝙣𝙞𝙚 𝘽𝙖𝙘𝙠 𝙏𝙤 𝙏𝙝𝙚 𝙃𝙤𝙢𝙚𝙋𝙖𝙜𝙚 🐬 <<=";
